...
for lt in language_type:
    with open("./{}/{}_comment_description.json".format(data_set, lt), 'r',
              encoding='utf8') as fr:
    ...
    for obj in json_data:
        des_str = json_data[obj]["description"][:100].replace(json_data[obj]["ent_name"],
                                                              "???")
    ...
    with open("./{}/{}_typing_result.json".format(data_set, lt), 'w', encoding='utf8') as fw:
